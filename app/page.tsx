    ...
    <main className="min-h-screen bg-[#fafaf9]">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 md:px-12 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-light text-[#1c1917] leading-tight animate-slide-up stagger-1">
            Capturing Life's
            <br />
            <span className="text-gradient font-medium">Beautiful Moments</span>
          </h1>

          <p className="text-xl md:text-2xl text-[#78716c] max-w-3xl mx-auto font-light leading-relaxed animate-slide-up stagger-2">
            Professional photography services for weddings, portraits, events, and more. 
            Based in Nigeria, creating timeless memories.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 animate-slide-up stagger-3">
            <button
              onClick={() => setShowBookingModal(true)}
              className="group relative px-8 py-4 bg-[#2d2a26] text-white rounded-xl font-medium text-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
            ...
            <button
              ...
              className="px-8 py-4 bg-white border-2 border-[#e7e5e4] text-[#2d2a26] rounded-xl font-medium text-lg hover:border-[#c67b5c] transition-all duration-300 hover:shadow-lg"
            >
              View Portfolio
            </button>
          </div>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 pt-16 max-w-3xl mx-auto animate-fade-in stagger-4">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-3xl md:text-4xl font-light text-[#c67b5c] mb-1">{stat.value}</div>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-scale-in">
            <div className="p-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-3xl font-light text-[#1c1917] mb-2">Book Your Session</h3>
                  <p className="text-[#78716c]">Fill out the form and we'll get back to you soon</p>
                </div>
                <button
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-5">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-6 py-3.5 bg-[#2d2a26] text-white rounded-xl hover:bg-[#3d3731] transition-all duration-300 hover:scale-105 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
